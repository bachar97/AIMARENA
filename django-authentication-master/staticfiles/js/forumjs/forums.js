  ...
  openmodal = function (id) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.data[0].User_Mode_user__Rank__Rank_image) {
          $('#userrank').attr('src', '/media/' + response.data[0].User_Mode_user__Rank__Rank_image);
          $('#userrank').show();
        } else {
          $('#userrank').hide();
        }
...
$("#ViewMore").click(function () {
  $(".grid-container").slideToggle(500);
