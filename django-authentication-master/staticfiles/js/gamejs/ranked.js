document.addEventListener("DOMContentLoaded", function(event) {
    ...
    restartgame = function() {
        ...
        ctx.fillText("Timer:" + " " + timerseconds + " " + "Shots: " + " " + shots + " Hits: " + " " + hits + " Accuracy: " + " " + accuracy + "%", 10, 30);
        startGameAgain();
		document.getElementById('scoretext').innerHTML = '';
		document.getElementById('accuracytext').innerHTML = '';
		$("#imagemodal").html('');
        $("#congrats").html('')
        $("#congrats").parent().addClass('demo2ovr');
    }
    ...
    function savetodb(){
        ...
        $.ajax({
            ...
            success: function(response){
				...
				document.getElementById('facebook').setAttribute("href", "https://www.facebook.com/sharer/sharer.php?u="+response["current_site"]+"&quote=I got " + response['score'] + " xp on AIMARENA");
                document.getElementById('twitter').setAttribute("href", "https://twitter.com/intent/tweet?via="+response["current_site"]+"&text=I got "+ response['score'] +" xp on AIMARENA" );
